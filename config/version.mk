...
ifneq ($(DEVICE_OVERLAYS),)
    DT_OFFICIAL := $(shell grep -h 'nexus_official_build">true<' $(DEVICE_OVERLAYS) 2>/dev/null)
    ifneq ($(DT_OFFICIAL),)
        NEXUS_DEVICES_XML := vendor/nexusOTA/devices.xml
        ifneq ($(wildcard $(NEXUS_DEVICES_XML)),)
